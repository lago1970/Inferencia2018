...
Estes exercícios tem como objetivo revisar os conceitos de probabilidades, distribuição amostral da média e intervalo de confiança para a média. Após um intervalo de tempo para que os alunos possam pensar nos conceitos e propor soluções para os exercícios ($\pm 15$ minutos) haverá uma discução em sala sobre a resolução dos exercícios e os temas envolvidos. 
...
_O documento fonte que gerou este arquivo e com a resolução dos exercícios está disponível em nossa página do curso_